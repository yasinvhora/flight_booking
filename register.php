                ...
                <div class="col-lg-4">
                    ...
                    <div class="padding-30px text-white background-dark border-1 border-grey-4 box-shadow">
                        <form method="post">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-block rounded-0 background-main-color" name="signup">
                            </div>
                                         already account ? <a href="login.php"><b style="padding-left: 5px; color:red;">Login</b></a>
